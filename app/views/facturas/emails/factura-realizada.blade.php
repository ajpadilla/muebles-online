...
<section>
	...
	<h2><em><a target="_blank" href="{{ route('facturas.show', $factura->id) }}">Ver en la Página</a></em></h2>
	<h2><em><a target="_blank" href="{{ route('pdf_invoice_path', $factura->id) }}">Obtener PDF</a></em></h2>
